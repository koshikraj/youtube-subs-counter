...
from controller import ChannelDetails, SubsCounter, SubsCounterCompared
...
apps.add_route("/channel/", ChannelDetails())
apps.add_route("/subscribers/", SubsCounter())
apps.add_route("/subscompare/", SubsCounterCompared())
